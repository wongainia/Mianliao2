...
public class TribeInfo implements Parcelable {
	...
	public static final JsonUtil.ITransformer<TribeInfo> TRANSFORMER = new JsonUtil.ITransformer<TribeInfo>() {
	...
	public static final Creator<TribeInfo> CREATOR = new Creator<TribeInfo>() {
	...
	public static TribeInfo fromJson(JSONObject json) {
		...
		tribeInfo.hasAssisted = json.optBoolean("has_assisted");
