...
import com.tjut.mianliao.profile.ProfileFragment.ViewPagerStateListener;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		underlineWidth = (int) TypedValue.applyDimension(
		        TypedValue.COMPLEX_UNIT_DIP, underlineWidth, dm);
		...
		underlineWidth = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsUnderlineWidth,
				underlineWidth);
